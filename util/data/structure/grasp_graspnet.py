...
def gen_mat(label_file,H=720, W=1280):
    ...
    # score = 0.9
    # rect_np = rect_np[rect_np[:,5]>score]
...
class GraspMat:
    ...
    def __init__(self, rect_path, ins_mask_path):
        ...
        while not found_valid_grasp:
            random_ins_value = random.choice(ins_value) #[3, 9, 12, 28, 52, 53, 59, 61, 64]
            # random_ins_value = 3
            positions = (instance_msk == random_ins_value) #720,1280 array
        ...
        instance_msk[instance_msk != random_ins_value] = 0 #720,1280
