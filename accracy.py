...
def main():
    ...
    nice_test_loader = DataLoader(cornell_test_dataset, batch_size=args.b, shuffle=False, num_workers=8,
                                  pin_memory=True)



    pretrain = '/data1/ori/checkpoint/0.994_cornell.pth'
